...
export default async function Home() {
  ...
  return (
    <>
      ...
      <main className="flex flex-col flex-1">
        ...
        <section className="relative h-[700px] flex items-center justify-center text-white text-center px-6 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-sm mb-6 tracking-wide">
              山陰（鳥取・島根）の犬オーナーのために
            </p>
            <p className="text-white/90 text-base sm:text-lg max-w-xl mx-auto mb-10">
        ...
        <section className="bg-[#FAF7F2] px-6 py-16">
          <div className="max-w-3xl mx-auto">
            ...
            {noteTopics.length === 0 ? (
              <p className="text-[#6B6A64] text-center py-10">準備中</p>
            ) : (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {CATEGORIES.map((cat) => (
              ...
              >
                ...
                <span className="text-xs text-[#6B6A64] text-center">
                  {cat.description}
                </span>
              </Link>
            ))}
      ...
      {/* フッター：#9E9D97 は #2C2C2A 背景上でコントラスト比5.5:1（WCAG AA達成） */}
