        ...
        <div className="max-w-2xl mx-auto w-full px-6 py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-[#2C2C2A] leading-relaxed mb-4">
              ...
              ドッグラン・動物病院・ペットホテル・ペットOK飲食店・ペット用品店＆サロン・保護犬情報まで、
          ...
          <section className="mb-12">
            ...
            <ul className="flex flex-col gap-4 text-[#2C2C2A] leading-relaxed text-sm">
              <li>
                「ペット用品店・サロン」カテゴリには、コンビニエンスストア・スーパーマーケット・100円均一ショップなど、犬用品の取り扱いが少ない、またはほとんどない店舗が含まれる場合があります。ご来店の際は事前にご確認いただくことをお勧めします。
              </li>
              <li>
